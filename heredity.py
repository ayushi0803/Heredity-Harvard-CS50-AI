...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if mother is None and father is None:
            ...
            # Probability that gene is passed from each parent
            probabilities_from_mother = (
                1 - PROBS["mutation"] if mother in two_genes else
                0.5 if mother in one_gene else
                PROBS["mutation"]
            )
            probabilities_from_father = (
            ...
            if genes == 2:
                probability *= probabilities_from_mother * probabilities_from_father
            elif genes == 1:
                probability *= (
                    probabilities_from_mother * (1 - probabilities_from_father) +
                    (1 - probabilities_from_mother) * probabilities_from_father
                )
            else:
                probability *= (1 - probabilities_from_mother) * (1 - probabilities_from_father)
